#!/usr/bin/env python3
# ---------------------------------------------------------------------------
# VENDORED from https://github.com/m4ary/zepp-health-cli
# Pinned commit: a466dfa (2026-04-18)
# Re-vendor manually by copying upstream zepp_health.py over this file and
# updating the SHA above. Do NOT add as git submodule or dependency —
# vendoring keeps this repo's dependency graph private.
# ---------------------------------------------------------------------------
